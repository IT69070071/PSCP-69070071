...
```text
รับค่าจำนวนเต็มมา แล้วเช็คว่าตั้งแต่ค่าที่รับจนถึง0มีเลขไหน หาร10ลงตัวบ้าง

input:ค่าNเริ่มต้น

output:เลขที่หาร10ลงตัวตั้งแต่N

constraints:ต้องนับ0 ด้วย
```
...
```text
step1:รับค่าN
step2:ไล่ตั้งแต่N-0ว่าตัวไหนหาร10ลงตัว
step3:เก็บเลขนั้นไว้ในlist
step4:print list 
```
...
```text
ทำเหมือนวิธีแรก แต่เปลี่ยนจากprint list เป็นการprint ต่อกันโดยตรงเลย 
```
...
```text
ทดสอบว่า โปรแกรมprint ค่าต่ำสุดเป็น0มั้ย
```
...
```text
ทดสอบว่าถ้าตัวเลขหลังไม่ใช่0 จะทำงานมั้ย
```
...
```text
ทดสอบว่าถ้าตัวเริ่มหาร10ลงตัว จะprintด้วยมั้ย
```
