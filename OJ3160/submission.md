...
```text
โจทย์ให้หาว่าระหว่าง จำนวนแรก ถึงจำนวนสุดท้ายมีจำนวนเฉพาะอะไรบ้างกี่ตัว

input:
จำนวนแรก ถึง จำนวนสุดท้าย ในบรรทัดเดียว

output:
จำนวนเฉพาะทั้งหมด
จำนวนของจำนวนเฉพาะทั้งหมด

constraints:
จำนวนเฉพาะจะนับตั้งแต่2ขึั้นไป, output ถ้าไม่มีจำนวนเฉพาะเลยให้printแค่จำนวนจำนวนของจำนวนเฉพาะทั้งหมด
```
...
```text
1.รับค่าจำนวนแรกและจำนวนสุดท้าย ในบรรทัดเดียวกัน
2.ให้count = 0
3.สร้างlist ของจำนวนเฉพาะ
4.loop(i)ค่าแรกถึงค่าสุดท้าย
5.ถ้า i น้อยกว่า2 ถือว่าไม่ใช่จำนวนเฉพาะ
6.loop(j)ตั้งแต่2ถึง i 
7.ถ้าi%j = 0 จะถือว่าไม่ใช่จำนวนเฉพาะ ข้ามloop 
8.ถ้าi%j != 0 จะถือว่าเป็นจำนวนเฉพาะ count +1 และเก็บค่า i ไว้ในlist
9.ถ้ามีจำนวนเฉพาะให้print บรรทัดแรกเป็น จำนวนเฉพาะทั้งหมด บรรทัดที่สองเป็นจำนวนของจำนวนเฉพาะทั้งหมด
10.ถ้าไม่มีจำนวนเฉพาะให้print แค่ จำนวนของจำนวนเฉพาะ
```
...
```text
เช็คcode ว่าได้ค่าตามต้องการมั้ย
```
