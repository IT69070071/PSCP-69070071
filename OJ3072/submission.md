...
```text
หาว่าในค่าที่รับมา มีสระกี่ตัว

input: string 1 ค่า

output: จำนวนสระ

constraints: output จะต้องprint สระกับจำนวน เช่น a : 4
```
...
```text
step1:รับค่าstring sentence
step2:สร้างdict เก็บตัวแปร
step3:ตรวจสอบว่าในstring มีสระกี่ตัว แล้วupdate  ค่าในdict
step4:print ค่า dict 
```
...
```text
เหมือนแผนแรก สร้างdict ตัวสระมาแล้วเช็ค เปลี่ยนค่า print ค่า
```
...
```text
ตรวจสอบว่าถ้าไม่มีค่าอะไรเข้าไปเลย
```
