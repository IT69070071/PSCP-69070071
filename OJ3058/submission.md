...
constraints:ถ้า จำนวนอิฐก้อนเล็กไม่พอ ให้print(-1) และต้องใช้อิฐแบบพอดี ถ้าอิฐก้อนใหญ่ต่อเลย ให้ใช้ค่าก่อนที่จะเกินแล้วเติมอิฐก้อนเล็ก
```
...
```text
step1:รับค่า จำนวนอิฐก้อนเล็ก
step2:รับค่า จำนวนอิฐก้อนใหญ่
step3:รับค่า ระยะทางที่ต้องต่อ
step4:หาว่าจำนวนอิฐก้อนใหญ่ที่ต้องใช้คือเท่าไหร่
step5:หาว่าเหลือระยะทางอีกกี่นิ้ว
step6:ตรวจสอบว่าระยะทางที่เหลือน้อยกว่าหรือมากกว่าจำนวนอิฐก้อนเล็ก
step7:ถ้าน้อยกว่าให้print ค่าระยะทางที่เหลือ
step8:ถ้ามากกว่าให้print -1
```
...
```text
เหมือนแผนแรก โดยหาจำนวนอิฐก้อนใหญ่ที่ใช้ จาก การหาว่าจำนวนอิฐก้อนใหญ่ที่มีมากกว่าหรือน้อยกว่า ค่าระยะทางหารไม่เอาเศษ5 เพราะอิฐก้อนใหญ่มีขนาด5นิ้ว เช่นสมมติว่า ระยะทางคือ12นิ้ว แล้วเรามีหินก้อนใหญ่อยู่3 เท่ากับว่าระยะทางทั้งหมดคือ15นิ้ว ซึ่งเกินกว่าที่ใช้ แต่ระยะทางหารไม่เอาเศษ5 จะได้2 เป็นระยะทาง10 นิ้วซึ่งตรงตามเงื่อไขที่โจทย์กำหนด ก็จะได้ค่าระยะทางหารไม่เอาเศษ5 ในทางกลับกัน ถ้าระยะทางคือ14และมีจำนวนอิฐใหญ่1ก้อน(เท่ากับ10นิ้ว) แล้วระยะทางหารไม่เอาเศษ5 จะได้2 ซึ่ง มันเกินกว่าจำนวนอิฐที่เรามี จึงใช้วิธีหาค่าที่น้อยที่สุด
```
...
```text
ทดสอบกรณีมีอิฐก้อนเล็กและก้อนใหญ่ไม่พอ
```
