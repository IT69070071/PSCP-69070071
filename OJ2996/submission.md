...
```text
โจทย์ให้รับค่าstringแล้วให้reverseตัวอักษรของstringนั้น

input:
string1ค่า

output:
ข้อความของstringที่รับค่ามา โดยreverseเปลี่ยนตัวอักษรกลับด้านหลังไปหน้่า

constraints:
output จะต้องเป็นตัวพิมพ์เล็กเท่านั้น
```
...
```text
1.รับค่าstring
2.reverse ตัวอักษรของstringนั้น
3.เปลี่ยนเป็นตัวพิมพ์เล็ก
4.print ค่าที่เปลี่ยนแล้ว
```
...
```text
วิธีที่ใช้เหมือนกันกับแผนแรก คือให้โปรแกรมรับค่า ข้อความstring มา แล้วเปลี่ยนข้อความนั้นกลับด้านจากหลังไปหน้า
จากนั้น เปลี่ยนให้เป็นตัวเล็กทั้งหมดแล้ว print ค่าที่เปลี่ยนแล้วออกมา 
```
...
```text
เพราะมีทั้งตัวพิมพ์เล็กและพิมพ์ใหญ่ผสมกัน
```
...
```text
อยากทดสอบว่า ถ้าเป็นตัวเลข จะให้ค่าoutputเหมือนกันมั้ย
```
