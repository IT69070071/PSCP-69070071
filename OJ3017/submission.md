...
```text
โจทย์ให้รับค่าจำนวนเต็ม จากนั้นหาค่าอีกค่าซึ่งคือ10%ของค่าที่รับมาแต่ถ้าค่านี้น้อยกว่า50ให้ใช้50และถ้ามากกว่า1000ให้ใช้1000 จากนั้นหาค่าอีกค่าซึ่งคือ7%ของค่าที่รับมาบวกกับค่าก่อนหน้าที่หามา จากนั้นแสดงผลค่าทั้ง3บวกกันเป็นทศนิยม2ตำแหน่ง

input: จำนวนเต็ม1ค่า

output:ค่าที่รับ+ 10%ของค่าที่รับมา แต่ถ้าค่านี้น้อยกว่า50ให้ใช้50และถ้ามากกว่า1000ให้ใช้1000+7%ของค่าที่รับบวกกับค่าก่อนหน้า เป็นทศนิยม2ตำแหน่ง

constarints:
ถ้าค่า10%ของค่าที่รับมามีค่านี้น้อยกว่า50ต้องใช้50แต่ถ้ามากกว่า1000ให้ใช้1000 
```
...
```text
1.รับค่าจำนวนเต็ม
2.คิดค่าแรก ค่า10%ของค่าที่รับ แต่ถ้าค่านี้คำนวนออกมาแล้วได้ต่ำกว่า50ให้ใช้50 แต่ถ้ามากกว่า1000ให้ใช้1000 
3.หาค่าที่สองค่า7%ของค่าแรกบวกกับค่าที่สอง
4.แสดงผลค่า3ค่านี้บวกกัน เป็นทศนิยม2ตำแหน่ง
```
...
```text
วิธีสุดท้ายใช้เหมือนกับแผนแรก คือรับค่าจำนวนเต็มมา จากนั้นหาค่า10%ของค่าที่รับแต่ถ้าค่าที่ได้นี้น้อยกว่า50ให้ใช้50แต่ถ้่ามากกว่า1000ให้ใช้1000 จากนั้นหาค่าต่อมาคือ7%ของค่าแรกบวกับค่าที่สอง แล้วแสดงผลทั้ง3ค่าบวกกันเป็นทศนิยม2ตำแหน่ง
```
...
```text
เพราะค่า10% ของค่านี้นั้นน้อยกว่า50 ซึ่งโปรแกรมควรจะให้ผลลัพท์ของค่านี้เป็น50ตามที่เขียนไว้ว่าถ้าน้อยกว่า50ให้ใช้50
```
...
```text
เพราะค่า10% ของค่าที่รับมันต้องมากกว่ากว่า1000 ซึ่งโปรแกรมควรจะให้ผลลัพท์ของค่านี้เป็น1000ตามที่เขียนไว้ว่าถ้ามากกว่า1000ให้ใช้1000
```
...
```text
เพราะถ้าค่าที่รับมาเป็น0ค่าที่ออกก้ควรจะเป็น0
```
