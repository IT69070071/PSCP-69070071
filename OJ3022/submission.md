...
```text
โจทย์ให้แปลงค่าอุณหภูมิจากหน่วยนึงไปอีกหน่วยนึง(C,K,F,R)

input: เลขอุณหภูมิ หน่วยตั้งต้น หน่วยที่ต้องการ

output: อุณหภูมิที่แปลงหน่วยแล้ว

constraints: สูตรที่ให้เป็นสูตรแปลงจากหน่วย C ไปหน่วยอื่น ถ้าต้องการแปลงจากหน่วยอื่นที่ไม่ใช่หน่วยCต้องแปลงเป็นCก่อน
```
...
```text
step1:รับค่าinput 3 บรรทัด เลขอุณหภูมิ หน่วยตั้งตั้น หน่วยที่ต้องการแปลง
step2:แปลงหน่วยตั้งต้นให้เป็นหน่วยCก่อนแล้วเก็บค่าไว้(ถ้าเป็นหน่วยCแล้วไม่ต้องแปลง)
step3:นำค่าที่แปลงมาแปลงอีกรอบให้เป็นหน่วยที่โจทย์ต้องการ
step4:print ค่าที่ได้
```
...
```text
ใช้ตามแผนแรก ที่ต้องแปลงจากหน่วยตั้งต้นให้เป็นหน่วยCก่อนเพราะโจทย์กำหนดสูตรแปลงจากหน่วยC 
```
...
```text
เพือเช็คว่าถ้าหน่วยเหมือนกันผลลัพท์จะออกมาเหมือนกัน
```
...
```text
เพื่อตรวจสอบว่าถ้าหน่วยตั้งต้นไม่ใช่หน่วยC ที่สูตรกำหนด จะยังแปลงได้มั้ย
```
