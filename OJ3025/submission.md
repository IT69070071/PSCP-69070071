...
```text
โจทย์ให้ตรวจสอบค่าที่ให้มาว่าอยู่ในฤดูไหนตามที่กำหนด แต่ถ้าค่าที่ให้ตรงกับอีกเงื่อนไขฤดูจะเปลี่ยน

input:วันที่กับเดือน

output:ถ้าเดือนที่รับเป็น1-3 จะเป็นwinter 4-6 เป็นspring 7-9 เป็นsummer 10-12เป็นfall

constraints:ถ้าเป็นเดือนที่3หารลงตัว และ ตั้งแต่วันที่ 21 ค่าoutput จะเปลี่ยนเป็น เดือนที่1-3 จะเป็นspring 4-6 เป็นsummer 7-9 เป็นfall 10-12เป็นwinter
```
...
step1:รับค่าวันที่
step2:รับค่าเดือน
step3:เช็คว่าเดือนหาร3ลงตัวมั้ย
step4:เช็คว่าวันที่เป็นวันที่ตั้งแต่21ขึ้นไปมั้ย
step5:ถ้า step3และ4ผ่าน ให้print ค่าโดยเดือนที่1-3 จะเป็นspring 4-6 เป็นsummer 7-9 เป็นfall 10-12เป็นwinter
step6:ถ้าstep 3และ4ไม่ผ่าน ให้print ค่าโดยเดือนที่1-3 จะเป็นwinter 4-6 เป็นspring 7-9 เป็นsummer 10-12เป็นfall
```
...
```text
วิธีสุดท้ายใช้เหมือนแผนแรก เพราะถูกต้องตามที่โจทย์ต้องการ
```
...
```text
เพราะเป็นเดือนที่3หารไม่ลงแต่วันที่เป็นวันที่21 ซึ่งตรงเงื่อนไขแค่1 ข้อ
```
...
```text
เพราะเป็นเดือนที่3หารลงและเลยวันที่21 ซึ่งตรงตามเงื่อนไขทั้ง2ประการ
```
...
```text
เพราะเป็นเดือนที่3หารไมาลงและยังไม่ถึงวันที่21 ซึ่งไม่ตรงตามเงื่อนไขอะไรเลย
```
