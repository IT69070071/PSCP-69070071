...
```text
โจทย์ให้คะแนนค่าเริ่มต้นเป็น0แล้วให้รับค่าจำนวนเต็มnแล้ว วนลูปรับคำสั่งจำนวนnครั้ง โดยคำสั่งจะมี + กับ - ถ้าเป็น+ให้คะแนนบวก10 ถ้าเป็น-คะแนนจะลบ5

input:
บรรทัดที่1 จำนวนเต็มN
บรรทัดที่2-N คำสั่ง + / -
...
1.รับค่าจำนวนเต็ม N
2.คะแนนเริ่มต้น=0
3.รับค่าคำสั่ง(+หรือ-) N ครั้ง
4.ถ้าคำสั่งเป็น+ ให้คะแนนบวก10
5.ถ้าคำสั่งเป็น- ให้คะแนนลบ5
6.print คะแนนสุดท้าย
```
