...
input:
ต้นทางและปลายทาง ในบรรทัดเดียวกัน
น้ำหนักสินค้า
output:
ราคาค่าใช้จ่ายหลังจากคำนวณแล้ว
constraints:
ถ้าจุดหมานและปลายถึงไม่อยู่ในตารางจะต้องได้Error
```
...
```text
1.นำเข้าต้นทางปลายทางในบรรทัดเดียว
2.แยกต้นทางกับปลายถึง
3.นำเข้าค่าน้ำหนัก
4.เทียบตารางต้นทางกับปลายถึง
5.รวมราคา
6.print ราคา
7.print error ถ้าต้นทางกับปลายทางไม่อยู่ในตาราง
```
