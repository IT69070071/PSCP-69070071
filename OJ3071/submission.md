...
```text
ให้หาว่าระหว่าง a-b มีกี่จำนวนที่หารด้วยd แล้วเหลือเศษr

input:ค่าเริ่มต้นa,ค่าสิ้นสุดb ค่าที่นำมาหารd เศษที่ต้องการr

output:จำนวนเลขระหว่างa-bที่หารด้วยd แล้วเหลือเศษr
```
...
```text
step1:input a ค่าเริ่มต้น
step2:input b ค่าสิ้นสุด
step3:input d จำนวนที่นำมาหาร
step4:input r เศษเหลือที่ต้องการ
step5:หาว่าระหว่างaถึงb มีกี่จำนวนที่หารด้วยd แล้วเหลือเศษr
step6:print ค่าที่ได้
```
...
```text
ใช้เหมือนแผนแรก และเพิ่มตอนหารให้เช็คค่าbด้วย
```
